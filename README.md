...
Site published at: https://antiusdragon.github.io/task-management/
...
-   Github pages
-   responsive design
-   repeta   tive content generation with JS
...
1. Clone the repo
    ```sh
    git clone https://github.com/AntiusDragon/task-management
    ```
